...
// mostly from: http://www.sitepoint.com/html5-ajax-file-upload/
var fileDragUpload =   {
...
/*****************Main code:**********************/
		...
		UploadFile: function(file) {
			...
			if (xhr.upload) {
				xhr.open("POST", fileDragUpload.$id("uploadForm").action, true);
				var boundary = "AJAX--------------" + (new Date).getTime(); // http://igstan.ro/posts/2009-01-11-ajax-file-upload-with-pure-javascript.html
		...
		ParseFile: function(file) {
			fileDragUpload.outputMessage("<p>File information: " + file.name + 
					"; type: " + file.type +
					"; size: " + file.size + "</p>");
		}
		*/
